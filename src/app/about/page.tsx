...
export default function AboutPage() {
  return (
    <div className="max-container gap-20 xl:flex-row items-end flex flex-col lg:flex-row justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0 px-5">
      <div className="w-full bg-white lg:w-1/2 flex flex-col ml-10 lg:px-2 xl:px-0 ">
        ...
        <p className="text-lg md:text-xl lg:text-2xl text-gray-500 my-12 px-5">
      ...
      <Image
        ...
        height={250}
        alt="world"
        className="relative right-0 -bottom-28 w-1/2  items-end flex lg:items-end justify-center"
      />
    </div>
  );
}
